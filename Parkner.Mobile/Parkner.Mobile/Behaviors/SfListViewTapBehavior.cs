...
namespace Parkner.Mobile.Behaviors
{
    ...
    public class SfListViewTapBehavior : Behavior<SfListView>
    {
        ...
        public static readonly BindableProperty CommandProperty =
            BindableProperty.Create(nameof(SfListViewTapBehavior.Command), typeof(ICommand), typeof(SfListViewTapBehavior));
        ...
        {
            get { return (ICommand)this.GetValue(SfListViewTapBehavior.CommandProperty); }
            set { this.SetValue(SfListViewTapBehavior.CommandProperty, value); }
        }
