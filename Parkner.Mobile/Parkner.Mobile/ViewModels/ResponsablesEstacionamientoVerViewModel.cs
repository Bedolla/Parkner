...
{
    public class ResponsablesEstacionamientoVerViewModel : BaseViewModel
    {
        private ICommand _borrarCommand;
        private string _cajones;
        private ICommand _cajonesCrudTapCommand;
        private int _cantidadEmpleados;
        private int _cantidadReservas;
        private string _direccion;
        private ICommand _editarCommand;
        private ICommand _empleadoCrearTapCommand;
        private ICommand _empleadoEditarTapCommand;
        private Estacionamiento _estacionamiento;
        private DateTime _fechaMinima;
        private DateTime _fin;
        private string _foto;
        private bool _habilitado;
        private ICommand _horarioCrearTapCommand;
        private ObservableCollection<Horario> _horarios;
        private ICommand _horarioTapCommand;
        private DateTime _inicio;
        private bool _mostrarEmpleados;
        ...
        public ResponsablesEstacionamientoVerViewModel
        (
        ...
        public bool MostrarEmpleados
        {
            get => this._mostrarEmpleados;
            set
            {
                this._mostrarEmpleados = value;
                this.OnPropertyChanged();
            }
        }

        public ICommand HorarioCrearTapCommand
        {
            get => this._horarioCrearTapCommand ??= new Command(this.HorarioCrear);
            set => this._horarioCrearTapCommand = value;
        }

        public ICommand HorarioEditarTapCommand
        {
            get => this._horarioTapCommand ??= new Command<ItemTappedEventArgs>(this.HorarioEditar);
            set => this._horarioTapCommand = value;
        }
        ...
        public ICommand CajonesCrudTapCommand
        {
            get => this._cajonesCrudTapCommand ??= new Command(this.CanojesCrud);
            set => this._cajonesCrudTapCommand = value;
        }

        public ICommand EmpleadoEditarTapCommand
        {
            get => this._empleadoEditarTapCommand ??= new Command<ItemTappedEventArgs>(this.EmpleadoEditar);
            set => this._empleadoEditarTapCommand = value;
        }

        public ICommand EmpleadoCrearTapCommand
        {
            get => this._empleadoCrearTapCommand ??= new Command(this.EmpleadoCrear);
            set => this._empleadoCrearTapCommand = value;
        }
        ...
        {
            await Dependencia.Navegacion.PushAsync(Dependencia.Obtener<ResponsablesEstacionamientoEditarPage>(this.Id));
        }

        private async void EmpleadoCrear()
        {
            await Dependencia.Navegacion.PushAsync(Dependencia.Obtener<ResponsablesEstacionamientoEmpleadoCrearPage>(this.Id));
        }

        private async void EmpleadoEditar(ItemTappedEventArgs argumentos)
        {
            if (argumentos.Item is Empleado empleado) await Dependencia.Navegacion.PushAsync(Dependencia.Obtener<ResponsablesEstacionamientoEmpleadoEditarPage>(empleado.Id));
        }

        private async void CanojesCrud()
        {
            await Dependencia.Navegacion.PushAsync(Dependencia.Obtener<ResponsablesEstacionamientoCajonesCrudPage>(this.Id));
        }
        ...
        private void HorarioEditar(ItemTappedEventArgs argumentos)
        {
            if (argumentos.Item is Horario horario) Dependencia.Navegacion.PushAsync(Dependencia.Obtener<ResponsablesEstacionamientoHorarioEditarPage>(horario.Id));
        }

        private async void HorarioCrear()
        {
            await Dependencia.Navegacion.PushAsync(Dependencia.Obtener<ResponsablesEstacionamientoHorarioCrearPage>(this.Id));
        }
        ...
        private async void Obtener()
        {
            ...
            this.CantidadEmpleados = this.Estacionamiento.Empleados.Count;
            this.MostrarReservas = this.CantidadReservas > 0;
            this.MostrarEmpleados = this.CantidadEmpleados > 0;

            if (this.MostrarEmpleados) this.Estacionamiento.Empleados.ForEach(e => e.Foto = $"{Uris.Fotos}{e.Foto}");
